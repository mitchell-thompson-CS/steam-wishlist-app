...
var { getWishlistPage, createWishlist, addGameToWishlist, getWishlistsPage, deleteWishlist, removeGameFromWishlist, addEditorToWishlist, deleteEditorFromWishlist, renameWishlist } = require("./wishlist.js");
...
app.post('/api/wishlist/rename', renameWishlist);
