...
const { renameWishlist, getWishlistInner, addGameToWishlists, removeGameFromWishlist, addEditorToWishlist, deleteEditorFromWishlist } = require('../../modules/wishlistInner');
